/**
 * Translate the behavior layer's LOGICAL surface to React DOM props.
 *
...
export type LogicalProps = Record<string, unknown>;

export function normalizeProps(logical: LogicalProps): Record<string, unknown> {
