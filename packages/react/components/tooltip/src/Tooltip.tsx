...
import { normalizeProps } from "@render-experiment/behavior-react";
import {
  placementToSide,
  type TooltipApi,
  type TooltipProps,
...
// -----------------------------------------------------------------------------
// <Tooltip> — provider, owns the behavior
// -----------------------------------------------------------------------------
...
export function TooltipTrigger({ children }: TooltipTriggerProps) {
  ...
  const triggerProps = {
    ...normalizeProps(api.trigger.handlers as unknown as Record<string, unknown>),
    ...normalizeProps(api.trigger.attrs as unknown as Record<string, unknown>),
...
function PositionedContent({
  ...
  const handlerProps = normalizeProps(api.content.handlers as unknown as Record<string, unknown>);
  const attrProps = normalizeProps(api.content.attrs as unknown as Record<string, unknown>);
