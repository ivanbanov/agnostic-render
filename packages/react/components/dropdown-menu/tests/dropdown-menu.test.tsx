  ...
  it('activation fires onCheckedChange with the toggled value', () => {
    ...
    render(
      <DropdownMenu defaultOpen>
        ...
        <DropdownMenu.Content>
          <DropdownMenu.CheckboxItem value='bold' checked={false} onCheckedChange={onCheckedChange}>
            Bold
  ...
  it('activating a RadioItem fires onValueChange with its value', () => {
    ...
    render(
      <DropdownMenu defaultOpen>
        ...
        <DropdownMenu.Content>
          <DropdownMenu.RadioGroup value='light' onValueChange={onValueChange}>
...
describe('data-state attributes', () => {
  ...
  it('checkbox item exposes data-state=checked / unchecked / indeterminate', () => {
    ...
    expect(screen.getByText('X').getAttribute('data-state')).toBe('indeterminate')
  })
})
